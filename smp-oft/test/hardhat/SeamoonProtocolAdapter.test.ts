...
describe('SeamoonProtocolAdapter Test', function () {
    ...
    before(async function () {
        ...
        MyOFTAdapter = await ethers.getContractFactory('SeamoonProtocolAdapterMock')

        MyOFT = await ethers.getContractFactory('SeamoonProtocolMock')
